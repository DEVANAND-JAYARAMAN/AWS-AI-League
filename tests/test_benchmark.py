"""
The 16-scenario evaluation benchmark. Deterministic and offline.
...
def _case_test_benchmark():
    ...
    from app.evaluation.scenarios.scenario_models import EvaluationMode, ScenarioCategory
    ...
    _rc = main()
    if _rc:
        raise SystemExit(f'test_benchmark returned exit code {_rc}')




_CASES = [
    ("test_benchmark", _case_test_benchmark)
]

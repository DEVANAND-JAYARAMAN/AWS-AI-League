...
Each scenario pairs a deterministic :class:`~app.core.game_state.GameState`
...
from app.evaluation.scenarios.scenario_models import (
    EvaluationMode,
    Scenario,
    ScenarioCategory,
)
from app.evaluation.scenarios.attacking_scenarios import build_attacking_scenarios
from app.evaluation.scenarios.defensive_scenarios import build_defensive_scenarios
from app.evaluation.scenarios.goalkeeper_scenarios import build_goalkeeper_scenarios
from app.evaluation.scenarios.transition_scenarios import build_transition_scenarios

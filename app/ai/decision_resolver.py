...
Takes the deterministic :class:`~app.core.team_coordinator.TeamDecision`,
the advisory :class:`~app.ai.response_parser.TacticalRecommendation`, and the
:class:`~app.ai.decision_comparator.DecisionComparison` between them, and
...
from app.ai.decision_comparator import AgreementLevel, DecisionComparison
from app.ai.response_parser import TacticalRecommendation
from app.core.decisions import FootballAction
from app.core.team_coordinator import TeamDecision, _action_priority

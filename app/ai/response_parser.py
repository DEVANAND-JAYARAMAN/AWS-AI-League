...
from app.ai.tactical_prompt import ALLOWED_ACTIONS, ALLOWED_MODES, KNOWN_AGENTS
...
def parse_recommendation(
    ...
    :data:`app.ai.tactical_prompt.KNOWN_AGENTS` list is used.
    """
